...
import { fetchGetPagingList, fetchDelete } from '@/service/api/device';
...
const { columns, data, loading, getData, getDataByPage, mobilePagination, searchParams, resetSearchParams } = useTable({
  ...
  columns: () => [
    ...
    },
    {
      ...
      title: $t('page.deviceConnection.connectionName'),
      align: 'center',
      minWidth: 120
    },
    {
    ...
    },
    {
      ...
      title: $t('page.deviceConnection.deviceModel'),
      align: 'center',
      minWidth: 120
    },
    {
      key: 'address',
      dataIndex: 'address',
      title: $t('page.deviceConnection.address'),
      align: 'center',
      minWidth: 120
    },
    {
...
function handleAdd() {
  ...
  void router.push({ name: 'industria_connection_action' });
}
...
function handleEdit(id: number) {
  appStore.tabStore.removeActiveTab();
  void router.push({ name: 'industria_connection_action', query: { id: String(id) } });
}
