const local: App.I18n.Schema = {
  ...
  page: {
    ...
    home: {
      goodMorning: '早上好 {userName}, 今天又是充满活力的一天!',
      goodAfternoon: '下午好 {userName}, 今天又是充满活力的一天!',
      goodEvening: '晚上好 {userName}, 今天又是充满活力的一天!',
      taskCount: '任务总数',
      pendingTaskCount: '待运行的任务',
    ...
    webApi:
    {
      ...
      form: {
          ...
          requestUrl: '请输入请求地址',
          timeOut: '请输入超时时间',
          queryParameter: '请输入查询参数',
          requestBodyContent: '请输入请求内容',
          header: '请输入请求头',
    ...
    authorize: {
      ...
      form: {
        ...
        tokenPath: '请输入令牌路径, 多级属性使用 (.) 连接，如：auth.token',
        tokenHandleLanguage: '请选择编程语言',
        tokenCode: '请输入令牌代码',
        tokenPassBy: '请选择令牌传递位置',
        tokenPrefix: '请输入令牌前缀',
        description: '请输入描述',
