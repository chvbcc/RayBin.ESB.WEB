const local: App.I18n.Schema = {
  ...
  page: {
    ...
    industriaApiDetail: {
      ...
      add: 'Add Device Node',
      edit: 'Edit Device Node',
      nodeList: 'Device Node List',
      industriaApiID: 'Interface ID',
      nodeName: 'Node Name',
      nodeID: 'Node ID',
      ...
      description: 'Description',
      form: {
        nodeName: 'Please enter node name (e.g., Temperature)',
        nodeID: 'Please enter node ID',
        nodeClass: 'Please select node type',
        variableName: 'Please enter variable name',
        value: 'Please enter variable value',
        builtInType: 'Please enter variable type',
