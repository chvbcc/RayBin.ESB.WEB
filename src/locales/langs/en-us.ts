const local: App.I18n.Schema = {
  ...
  page: {
    ...
    webApi:
    {
      ...
      judgeCondition: 'Judge Condition',
      handleCallResult: 'Handle Call Result',
      dataMapping: 'Data Mapping',
      ...
      form: {
          ...
          requestBodyType: 'Please select request body type',
          ...
          judgeMode: 'Please select judge mode',
          judgeCondition: 'Please enter judge condition',
          handleCallResult: 'Please select handle call result',
          dataMapping: 'Please enter data mapping',
