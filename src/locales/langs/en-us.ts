const local: App.I18n.Schema = {
  ...
  common: {
    action: 'Action',
    getDataFailed: 'Failed to fetch data, please try again later!',
    add: 'Add',
  ...
  page: {
    ...
    home: {
      goodMorning: 'Good morning {userName}, today is another day full of vitality!',
      goodAfternoon: 'Good afternoon {userName}, today is another day full of vitality!',
      goodEvening: 'Good evening {userName}, today is another day full of vitality!',
